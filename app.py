...
with st.sidebar:
    ...
    dashboard = st.radio(
        "🗂️ Select Dashboard",
        ["🌀 Cyclone Dashboard", "🌡️ Heatwave & Coldwave Dashboard", "🌫️ Air Quality Index Dashboard"],
    )

    st.markdown("---")

    db_key = "cyc" if "Cyclone" in dashboard else ("hw" if "Heatwave" in dashboard else "aqi")
